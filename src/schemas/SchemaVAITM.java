...
public class SchemaVAITM extends Schemas {
    ...
    public Map<String, Object> getData() throws Exception{
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],this.getParentSchema("VAHDR").getMapItem("Sales Doc")); //Sales Doc
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],tData.getMaterial("Material entered", columns.get("Material").toString())); //Material entered
        columns.put(this.getMetaValues("header")[this.nextColumn()],tData.getMaterial("Matl Group", columns.get("Material").toString())); //Material group
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],tData.getMaterial("Customer Material Number", columns.get("Material").toString())); //Customer Material Number
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],columns.get("Overdel Tol")); //Underdel Tol
        ...
        if(this.getRowCount() > 1) {
            ...
            columns.put(this.getMetaValues("header")[this.nextColumn()],this.getParentSchema("VAHDR").getMapItem("Net value"));
        }
        this.setMasterData("Net value", columns.get("Net value")); 
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],columns.get("Order Quantity")); //Required deliv. qty
        columns.put(this.getMetaValues("header")[this.nextColumn()],columns.get("Order Quantity")); //Cumul.confirmed qty
        columns.put(this.getMetaValues("header")[this.nextColumn()],columns.get("UoM")); //Su
        String WUn = dg.getItem("TO",0.66,"KG");
        columns.put(this.getMetaValues("header")[this.nextColumn()],Double.parseDouble(columns.get("Order Quantity").toString()) * convert.get(columns.get("SU") + WUn)); //Gross Weight
        ...
        if(this.getCurrentRow() == 1) {
            baseDate = (Date)this.getParentSchema("VAHDR").getMapItem("Created on");
        ...
        if(columns.get("ComRl") != null && columns.get("ComRl") != "B") {
            columns.put(this.getMetaValues("header")[this.nextColumn()],dg.getDate((Date)columns.get("Created on"), this.parseDouble(this.getMetaValues("avg")[this.getColumnNumber()-1]), this.parseDouble(this.getMetaValues("std")[this.getColumnNumber()-1]))); //BOM key dt.
        } else {
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],dg.getCurrency(this.parseDouble(this.getMetaValues("avg")[this.getColumnNumber()-1]), this.parseDouble(this.getMetaValues("std")[this.getColumnNumber()-1]),Double.parseDouble(columns.get("Net value").toString()))); //Cost
        columns.put(this.getMetaValues("header")[this.nextColumn()],dg.getCurrency(this.parseDouble(this.getMetaValues("avg")[this.getColumnNumber()-1]), this.parseDouble(this.getMetaValues("std")[this.getColumnNumber()-1]),Double.parseDouble(columns.get("Net value").toString()))); //Value of inv.gross
        columns.put(this.getMetaValues("header")[this.nextColumn()],dg.getCurrency(this.parseDouble(this.getMetaValues("avg")[this.getColumnNumber()-1]), this.parseDouble(this.getMetaValues("std")[this.getColumnNumber()-1]),Double.parseDouble(columns.get("Net value").toString()))); //Value w/o freight
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],columns.get("Net value")); //Freight cost and r
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],this.getMasterData("Profit Ctr", this.getColumnNumber()-1, this.getCurrentRow(), this.fillString(dg.getNumberUpTo(1000000000).toString(), "0", 10))); //Profit Center
        columns.put(this.getMetaValues("header")[this.nextColumn()],this.getMasterData("MG 2", this.getColumnNumber()-1, this.getCurrentRow(), dg.getItem("B" + this.fillString(dg.getNumberUpTo(99).toString(), "0", 2),0.33,null))); //MG 2
        columns.put(this.getMetaValues("header")[this.nextColumn()],this.getMasterData("MG 3", this.getColumnNumber()-1, this.getCurrentRow(), dg.getItem("B" + this.fillString(dg.getNumberUpTo(99).toString(), "0", 2),0.20,null))); //MG 3
        columns.put(this.getMetaValues("header")[this.nextColumn()],this.getMasterData("MG 4", this.getColumnNumber()-1, this.getCurrentRow(), dg.getItem("B" + this.fillString(dg.getNumberUpTo(99).toString(), "0", 2),0.08,null))); //MG 4
        columns.put(this.getMetaValues("header")[this.nextColumn()],this.getMasterData("MG 5", this.getColumnNumber()-1, this.getCurrentRow(), "B" + this.fillString(dg.getNumberUpTo(99).toString(), "0", 2))); //MG 5
        ...
        columns.put(this.getMetaValues("header")[this.nextColumn()],Double.parseDouble(columns.get("Net value").toString())*0.20); //Tax Amount
        ...
        if(columns.get("Credit active") != null && "X".equals(columns.get("Credit active").toString())) {
            ...
            columns.put(this.getMetaValues("header")[this.nextColumn()],columns.get("Pint"));
        } else {
        ...
        if(columns.get("Credit active") != null && "X".equals(columns.get("Credit active").toString())) {
            columns.put(this.getMetaValues("header")[this.nextColumn()],dg.getDate((Date)columns.get("Created on"), this.parseDouble(this.getMetaValues("avg")[this.getColumnNumber()-1]), this.parseDouble(this.getMetaValues("std")[this.getColumnNumber()-1]))); //First Load
        } else {
            columns.put(this.getMetaValues("header")[this.nextColumn()],null);
        }
        this.setMap(columns);
